var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,f,e){b instanceof String&&(b=String(b));for(var m=b.length,k=0;k<m;k++){var l=b[k];if(f.call(e,l,k,b))return{i:k,v:l}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
(function(b){function f(b){var e=0,f;for(f in b)b.hasOwnProperty(f)&&e++;return e}var e={},m={arabic:"Arabic",bengali:"Bengali","chinese-hongkong":"Chinese (Hong Kong)","chinese-simplified":"Chinese (Simplified","chinese-traditional":"Chinese (Traditional)",cyrillic:"Cyrillic","cyrillic-ext":"Cyrillic Extended",devanagari:"Devanagari",greek:"Greek","greek-ext":"Greek Extended",gujarati:"Gujarati",gurmukhi:"Gurmukhi",hebrew:"Hebrew",japanese:"Japanese",kannada:"Kannada",khmer:"Khmer",korean:"Korean",
    ...
    Asul:{category:"sans-serif",variants:"400,700",subsets:"latin"},Athiti:{category:"sans-serif",variants:"200,300,400,500,600,700",subsets:"latin,latin-ext,thai,vietnamese"},Atma:{category:"display",variants:"300,400,500,600,700",subsets:"bengali,latin,latin-ext"},"Atomic Age":{category:"display",variants:"400",subsets:"latin"},Aubrey:{category:"display",variants:"400",subsets:"latin"},Audiowide:{category:"display",variants:"400",subsets:"latin,latin-ext"},"Autour One":{category:"display",variants:"400",
        ...
        subsets:"latin,latin-ext,thai,vietnamese"},"Baloo 2":{category:"display",variants:"400,500,600,700,800",subsets:"devanagari,latin,latin-ext,vietnamese"},"Baloo Bhai 2":{category:"display",variants:"400,500,600,700,800",subsets:"gujarati,latin,latin-ext,vietnamese"},"Baloo Bhaina 2":{category:"display",variants:"400,500,600,700,800",subsets:"latin,latin-ext,oriya,vietnamese"},"Baloo Chettan 2":{category:"display",variants:"400,500,600,700,800",subsets:"latin,latin-ext,malayalam,vietnamese"},"Baloo Da 2":{category:"display",
        variants:"400,500,600,700,800",subsets:"bengali,latin,latin-ext,vietnamese"},"Baloo Paaji 2":{category:"display",variants:"400,500,600,700,800",subsets:"gurmukhi,latin,latin-ext,vietnamese"},"Baloo Tamma 2":{category:"display",variants:"400,500,600,700,800",subsets:"kannada,latin,latin-ext,vietnamese"},"Baloo Tammudu 2":{category:"display",variants:"400,500,600,700,800",subsets:"latin,latin-ext,telugu,vietnamese"},"Baloo Thambi 2":{category:"display",variants:"400,500,600,700,800",subsets:"latin,latin-ext,tamil,vietnamese"},
    "Balsamiq Sans":{category:"display",variants:"400,400i,700,700i",subsets:"cyrillic,cyrillic-ext,latin,latin-ext"},Balthazar:{category:"serif",variants:"400",subsets:"latin"},Bangers:{category:"display",variants:"400",subsets:"latin,latin-ext,vietnamese"},Barlow:{category:"sans-serif",variants:"100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i",subsets:"latin,latin-ext,vietnamese"},"Barlow Condensed":{category:"sans-serif",variants:"100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i",
    ...
    Kantumruy:{category:"sans-serif",variants:"300,400,700",subsets:"khmer"},Karla:{category:"sans-serif",variants:"200,300,400,500,600,700,800,200i,300i,400i,500i,600i,700i,800i",subsets:"latin,latin-ext"},Karma:{category:"serif",variants:"300,400,500,600,700",subsets:"devanagari,latin,latin-ext"},Katibeh:{category:"display",variants:"400",subsets:"arabic,latin,latin-ext"},"Kaushan Script":{category:"handwriting",variants:"400",subsets:"latin,latin-ext"},Kavivanar:{category:"handwriting",variants:"400",
        subsets:"latin,latin-ext,tamil"},Kavoon:{category:"display",variants:"400",subsets:"latin,latin-ext"},"Kdam Thmor":{category:"display",variants:"400",subsets:"khmer"},"Keania One":{category:"display",variants:"400",subsets:"latin,latin-ext"},"Kelly Slab":{category:"display",variants:"400",subsets:"cyrillic,latin,latin-ext"},Kenia:{category:"display",variants:"400",subsets:"latin"},Khand:{category:"sans-serif",variants:"300,400,500,600,700",subsets:"devanagari,latin,latin-ext"},Khmer:{category:"display",
    ...
    "Xanh Mono":{category:"monospace",variants:"400,400i",subsets:"latin,latin-ext,vietnamese"},"Yanone Kaffeesatz":{category:"sans-serif",variants:"200,300,400,500,600,700",subsets:"cyrillic,latin,latin-ext,vietnamese"},Yantramanav:{category:"sans-serif",variants:"100,300,400,500,700,900",subsets:"devanagari,latin,latin-ext"},"Yatra One":{category:"display",variants:"400",subsets:"devanagari,latin,latin-ext"},Yellowtail:{category:"handwriting",variants:"400",subsets:"latin"},"Yeon Sung":{category:"display",
        ...
        sampleTextEditable:"Texto de ejemplo, editable"}},y={lang:"en",variants:!0,nrRecents:3,lazyLoad:!0,debug:!1,localFontsUrl:"/fonts/",parentElement:"body",localFonts:{Arial:{category:"sans-serif",variants:"400,400i,600,600i"},"Courier New":{category:"monospace",variants:"400,400i,600,600i"},Georgia:{category:"serif",variants:"400,400i,600,600i"},Tahoma:{category:"sans-serif",variants:"400,400i,600,600i"},"Times New Roman":{category:"serif",variants:"400,400i,600,600i"},"Trebuchet MS":{category:"sans-serif",
            variants:"400,400i,600,600i"},Verdana:{category:"sans-serif",variants:"400,400i,600,600i"}}},z=function(){function l(a,c){if(c.googleFonts&&Array.isArray(c.googleFonts)){for(var d={},h,g=0;g<c.googleFonts.length;g++)h=c.googleFonts[g],d[h]=u[h];c.googleFonts=d}else!1!==c.googleFonts&&(c.googleFonts=u);c.localFonts||(c.localFonts=[]);x[c.lang]||(c.lang="en");this.dictionary=x[c.lang];this.allFonts={google:c.googleFonts,local:c.localFonts};this.options=c;this.$original=b(a);this.setupHtml();this.bindEvents()}
    l.prototype={loadFont:function(a,c){if(!e[c])switch(e[c]=!0,a){case "google":a="https://fonts.googleapis.com/css?family="+c.replace(/ /g,"+")+":"+this.options.googleFonts[c].variants+"&display=swap";this.options.debug&&console.log("Loading Google font "+c+" from "+a);b("head").append(b("<link>",{href:a,rel:"stylesheet",type:"text/css"}));break;case "local":this.options.debug&&console.log("Loading local font "+c),b("head").append("<style> @font-face { font-family:'"+c+"'; src:local('"+c+"'), url('"+
            this.options.localFontsUrl+c+".woff') format('woff'); } </style>")}},showSample:function(a){b(".fp-sample",this.$element).css({fontFamily:"'"+a.data("font-family")+"'",fontStyle:a.data("font-italic")?"italic":"normal",fontWeight:a.data("font-weight")||400})},keyDown:function(a,c){function d(a){a.preventDefault();a.stopPropagation()}c=b("li.fp-active:visible",this.$results);if(49<=a.keyCode&&57>=a.keyCode||97<=a.keyCode&&105>=a.keyCode)d(a),b(".fp-pill[data-font-weight="+100*(a.keyCode-(97<=a.keyCode?
            96:48))+"]",c).trigger("click");else switch(a.keyCode){case 73:d(a);b(".fp-pill.italic:visible",c).trigger("click");break;case 38:d(a);$prevLi=c.prevAll(":not(.fp-divider):visible:first");0==$prevLi.length&&($prevLi=b("li:not(.fp-divider):visible:last",this.$results));$prevLi.trigger("mouseenter").trigger("click");q($prevLi[0]);break;case 40:d(a);$nextLi=c.nextAll(":not(.fp-divider):visible:first");0==$nextLi.length&&($nextLi=b("li:not(.fp-divider):visible:first",this.$results));$nextLi.trigger("mouseenter").trigger("click");
            q($nextLi[0]);break;case 13:d(a);b("li.fp-active",this.$results).find("button.apply").trigger("click");break;case 27:d(a),b(".fp-close",this.$modal).trigger("click")}},mouseEnter:function(a,c){a=b(c);b("li.fp-hover",this.$results).removeClass("fp-hover");a.addClass("fp-hover");this.loadFont(a.data("font-type"),a.data("font-family"));this.showSample(a)},click:function(a,c){var d=b(c),h=this,g=d.data("font-type"),e=d.data("font-family"),f=d.data("font-italic")||!1,p=d.data("font-weight")||400,m=b("li[data-font-family='"+
            e+"']",this.$results),k=(a=n("favs"))?a.split(","):[];b("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove();d.addClass("fp-active");a=b('<div class="fp-btns">');c=-1!=k.indexOf(g+":"+e);a.append(b('<span class="fp-favorite'+(c?" checked":"")+'"></span>').on("click",function(a){a.stopPropagation();a=k.indexOf(g+":"+e);b(this).is(".checked")?-1!=a&&k.splice(a,1):-1==a&&k.push(g+":"+e);b(this).toggleClass("checked");n("favs",k.join(","))}),b('<button type="button" class="fp-btn apply">').html(this.dictionary.select).on("click",
            function(a){a.stopPropagation();f=d.data("font-italic");p=d.data("font-weight")||400;a=e;h.options.variants&&(a+=":"+p+(f?"i":""));h.$select.css({fontFamily:"'"+e+"'",fontStyle:f?"italic":"normal",fontWeight:p}).find(".fp-fontspec").html(a);h.$original.val(a).change();if(h.options.onSelect)h.options.onSelect({fontType:g,fontFamily:e,fontStyle:f?"italic":"normal",fontWeight:p,fontSpec:a});h.toggleModal("hide");if(h.options.nrRecents){a=n("recents");var b=d.data("font-type")+":"+e;a=a?a.split(","):
                [];-1==a.indexOf(b)&&a.unshift(b);a=a.slice(0,h.options.nrRecents);n("recents",a.join(","))}}));a.appendTo(d);a=this.allFonts[g][e];var l=a.variants?a.variants.split(","):[];if(this.options.variants&&1<l.length){a=b('<div class="fp-variants">');c=!1;for(var r={},t=0;t<l.length;r={$jscomp$loop$prop$fontWeight$1:r.$jscomp$loop$prop$fontWeight$1},t++)if(/i$/.test(l[t]))c||(c=!0);else{var q=l[t];r.$jscomp$loop$prop$fontWeight$1=+q.replace(/i$/,"");0<t&&a.append(" ");b('<span data-font-weight="'+r.$jscomp$loop$prop$fontWeight$1+
            '" class="fp-pill weight'+(p==r.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').text(q).on("click",function(a){return function(c){c.stopPropagation();-1==l.indexOf(a.$jscomp$loop$prop$fontWeight$1+"i")?(b(".fp-pill.italic",d).removeClass("checked").css("display","none"),f=!1,d.data("font-italic",f)):b(".fp-pill.italic",d).css("display","");b("span.fp-pill.weight",d).removeClass("checked");b(this).addClass("checked");m.data("font-weight",a.$jscomp$loop$prop$fontWeight$1);h.showSample(d)}}(r)).appendTo(a)}c&&
        (a.append(" "),b('<span class="fp-pill italic '+(f?" checked":"")+'">').css("display",-1==l.indexOf(p+"i")?"none":"").html("italic").on("click",function(a){a.stopPropagation();f=!f;b(this).toggleClass("checked");m.data("font-italic",f);h.showSample(d)}).appendTo(a));d.append(a)}else 1==l.length&&/i$/.test(l[0])&&m.data("font-italic",!0)},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var d=b[1]||"400";b=!1;/(\d+)i$/.test(d)?(b=!0,d=+RegExp.$1):d=+d;return{family:a,weight:d,italic:b}},
        applyFontToOriginalInput:function(a){if(""===a)this.$select.removeAttr("style").find(".fp-fontspec").html(this.dictionary.selectFont),this.$original.val("");else{var b=this.fontSpecToComponents(a);this.loadFont(!1!==this.options.googleFonts&&u[b.family]?"google":"local",b.family);this.$select.css({fontFamily:"'"+b.family+"'",fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find(".fp-fontspec").html(a)}},bindEvents:function(){var a=this;this.$results.on("keydown",function(b){a.keyDown(b,
            this)}).on("mouseenter","li:not(.fp-divider):visible",function(b){a.mouseEnter(b,this)}).on("click","li:not(.fp-divider):visible",function(b){a.click(b,this)}).on("dblclick","li:not(.fp-divider):visible",function(a){b("li.fp-active",this.$results).find("button.apply").trigger("click")});this.$original.on("change",function(b){a.applyFontToOriginalInput(this.value)})},lazyLoad:function(){if(window.IntersectionObserver){var a=this,c,d=new IntersectionObserver(function(h){[].forEach.call(h,function(g){0<
        g.intersectionRatio&&(d.unobserve(g.target),c=b(g.target),a.loadFont(c.data("font-type"),c.data("font-family")),c.css("fontFamily","'"+c.data("font-family")+"'"))})});b("li:not(.fp-divider)",this.$results).each(function(){d.observe(this)})}},toggleModal:function(a){a||(a=this.$modal.is(":visible")?"hide":"show");if("hide"==a)b(".fp-fav,.fp-variants,.fp-btns").remove(),this.$modal.css("display","none"),b(".fp-modal-backdrop",this.$element).remove(),b(this.options.parentElement).removeClass("fp-modal-open"),
            b("span",this.$select).focus();else{b(this.options.parentElement).addClass("fp-modal-open");this.$element.append(b('<div class="fp-modal-backdrop">').on("click",function(){b(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");this.getFavorites();if(a=this.$original.val()){a=this.fontSpecToComponents(a);var c=b("li[data-font-family='"+a.family+"']",this.$results);0<c.length&&(c.data({"font-italic":a.italic,"font-weight":a.weight}).eq(0).trigger("click"),q(c[0]))}else this.$results.scrollTop(0);
            this.options.lazyLoad&&this.lazyLoad();this.$results.focus()}},applyFilter:function(){var a=this.$lang.val(),c=this.$search.val().trim(),d=[];b(".fp-category",this.$filter).each(function(){b(this).hasClass("checked")&&d.push(b(this).data("category"))});n("lang",""===a?!1:a);n("cats",d.join(","));for(var h in this.allFonts)for(var g in this.allFonts[h]){var e=this.allFonts[h][g],f=e.subsets?e.subsets.split(","):[],p=b("li[data-font-family='"+g+"']",this.$results);e=e.category||"other";""!=a&&-1==f.indexOf(a)||
        -1==d.indexOf(e)||""!=c&&-1==g.toLowerCase().indexOf(c.toLowerCase())?p.hide():p.show()}},getFilterUI:function(){var a=this,c=b('<div class="fp-search-wrap">');this.$filter=b('<div class="fp-filter">');this.$search=b("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search,spellcheck:!1}).on("keyup",function(){a.applyFilter()}).appendTo(c);b('<div class="fp-clear">').on("click",function(){a.$search.val("").focus();a.applyFilter()}).appendTo(c);var d=['<option value="">'+this.dictionary.allLangs+
        "</option>"],h;for(h in m)d.push('<option value="'+h+'">'+m[h]+"</option>");this.$lang=b('<select class="fp-lang">').on("change",function(){a.applyFilter()}).html(d.join(""));this.$filter.append(b('<div class="fp-row">').append(c,this.$lang));b('<div class="hr">').appendTo(this.$filter);c=k.slice(0);c.push("other");for(d=0;d<c.length;d++)b('<span class="fp-category fp-pill checked">').data("category",c[d]).text(c[d]).on("click",function(){b(this).toggleClass("checked");a.applyFilter()}).appendTo(this.$filter)},
        getFontsList:function(){function a(a,h){var e=c.allFonts[a][h],f="";if(e.category||e.variants)f=[],e.category&&f.push(e.category),c.options.variants&&e.variants&&(e=e.variants.split(",").length,1<e&&f.push(e+" "+c.dictionary.styles)),f=" <small>"+f.join(", ")+"</small>";g=b("<li>",{"data-font-type":a,"data-font-family":h}).html(h+f);d.append(g[0])}var c=this,d=b(document.createDocumentFragment()),h;if(0<f(this.options.localFonts)){var g=b('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");
            d.append(g[0]);for(h in this.options.localFonts)a("local",h)}if(0<f(this.options.googleFonts))for(h in g=b('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(g[0]),this.options.googleFonts)a("google",h);this.$results=b("<ul>",{"class":"fp-results",tabindex:0}).append(d)},getFavorites:function(){var a=n("favs"),c=n("recents");a=a?a.split(","):[];c=this.options.nrRecents&&c?c.split(","):[];c=c.slice(0);for(var d=0;d<a.length;d++)-1==c.indexOf(a[d])&&c.push(a[d]);a=b(document.createDocumentFragment());
            var e=null;for(d=0;d<c.length;d++){var g=c[d].split(":");fontType=g[0];fontFamily=g[1];if(font=this.allFonts[fontType][fontFamily])g=b("[data-font-family='"+fontFamily+"']",this.$results),0<g.length&&(e=g.clone().addClass("fp-fav"),a.append(e[0]))}null!==e&&(a.prepend(b('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(a))},setupHtml:function(){var a=this,c=this.$original.val();this.$original.hide();this.$select=b('<div class="font-picker fp-select">').on("click",
            function(){a.toggleModal("show")}).on("keydown",function(b){32==b.keyCode&&(b.stopPropagation(),b.preventDefault(),a.toggleModal("show"))}).append('<span class="fp-fontspec" tabindex="0">'+(c?c:this.dictionary.selectFont)+"</span>");a.options.showClear&&a.$select.append(b('<span class="fp-clear"></span>').on("click",function(b){b.stopPropagation();a.$select.removeAttr("style").find(".fp-fontspec").html(a.dictionary.selectFont);a.$original.val("").change()}));this.$original.after(this.$select);this.$element=
            b("<div>",{"class":"font-picker"});this.$modal=b('<div class="fp-modal">').appendTo(this.$element);this.$modal.append(b('<div class="fp-header">').append(b('<div class="fp-icons">').append(b('<span class="fp-close">&times</span>').on("click",function(){a.toggleModal("hide")})),b("<h5>").text(this.dictionary.selectFont)));this.getFilterUI();this.$modal.append(this.$filter);this.$sample=b("<div>",{"class":"fp-sample",contenteditable:!0,spellcheck:!1,title:this.dictionary.sampleTextEditable}).html(this.dictionary.sampleText).appendTo(this.$modal);
            this.getFontsList();this.$modal.append(this.$results);var d=n("lang"),e=n("cats");d&&this.$lang.val(d);e&&(e=e.split(","),b(".fp-category",this.$filter).each(function(){-1==e.indexOf(b(this).data("category"))?b(this).removeClass("checked"):b(this).addClass("checked")}));(d||e)&&a.applyFilter();c&&a.applyFontToOriginalInput(c);b(this.options.parentElement).append(this.$element)},show:function(){var a=b(this).data("plugin_fontpicker");if(!a.$select)throw Error("jquery.fontpicker: Cannot show, as I've been destroyed.");
            a.toggleModal("show")},hide:function(){var a=b(this).data("plugin_fontpicker");if(!a.$select)throw Error("jquery.fontpicker: Cannot hide, as I've been destroyed.");a.toggleModal("hide")},destroy:function(){var a=b(this).data("plugin_fontpicker");if(!a.$select)throw Error("jquery.fontpicker: Cannot destroy, as I've been destroyed already.");a.toggleModal("hide");a.$select.remove();a.$element.remove();a.$original.off("setFont");a.$original.show();a.$select=a.$element=a.$original=a.$modal=null;b(a).removeData("plugin_fontpicker")}};
    return l}();if("string"===typeof arguments[0]){var v=arguments[0],A=Array.prototype.slice.call(arguments,1),w;this.each(function(){if(b.data(this,"plugin_fontpicker")&&"function"===typeof b.data(this,"plugin_fontpicker")[v])w=b.data(this,"plugin_fontpicker")[v].apply(this,A);else throw Error("jquery.fontpicker: Method "+v+" does not exist.");});return void 0!==w?w:this}return this.each(function(){b.data(this,"plugin_fontpicker")||(l&&b.extend(y,l),b.data(this,"plugin_fontpicker",new z(this,y)))})}})(jQuery);
